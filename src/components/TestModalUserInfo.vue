<template>
  <div class="modal fade" v-bind:id="'testModalUserInfo'" tabindex="-1" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="user-info-modal-body">
          ...
          <form class="user-info-form" enctype="multipart/form-data" @submit.prevent.stop="handleSubmit"
            ...
            <div class="user-info-modal-header-right-wrapper">
              <button type="submit" class="btn btn-user-info-modal" data-bs-dismiss="modal" aria-label="Close"
